...
window.app = new _Vue2.default({
	el: 'body',
	components: { Cart: _Cart2.default, Products: _Products2.default, Product: _Product2.default, Search: _Search2.default, Menu: _Menu2.default, CleanCart: _CleanCart2.default, Order: _Order2.default },
	data: {
...
},{"./components/Cart.vue":50,"./components/CleanCart.vue":51,"./components/Menu.vue":52,"./components/Order.vue":53,"./components/Product.vue":54,"./components/Products.vue":55,"./components/Search.vue":56,"Vue":1,"vue-resource":47}],50:[function(require,module,exports){
'use strict';
...
},{"babel-runtime/core-js/json/stringify":2,"vue":48,"vue-hot-reload-api":46}],51:[function(require,module,exports){
'use strict';
...
},{"vue":48,"vue-hot-reload-api":46}],53:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	created: function created() {
		...
		console.log((0, _stringify2.default)(this.request));

		this.$http.post('http://201.203.229.106:90/api/v1/proformas', (0, _stringify2.default)(this.request)).then(function (response) {

			// get status
			console.log(response.status);
			// set data on vm
			_this.$set('data', response.json());
		}, function (response) {
...
},{"babel-runtime/core-js/json/stringify":2,"vue":48,"vue-hot-reload-api":46}],54:[function(require,module,exports){
'use strict';
